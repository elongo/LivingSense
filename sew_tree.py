...
REST_API_URL = "https://api.powerbi.com/beta/d9dc4061-aba4-47ad-9604-c994ff5caff0/datasets/c46ba680-bc02-41d9-8105-fc1faeda5f8d/rows?key=M9trNzRvwvaLZNLz724iZrs060QC34v4LAdTEF2Twd4TW9hC3qozEY4CcIok%2FxrXYypUZRTdNjFZq2AzpJzPtA%3D%3D"
...
def vwc():
    try:
        ...
        for i in range(3):
            ...
            #VWC[i+1] =  (-0.0083*values[i]) + 100.81 # Old valibration made by EL (ADJUSTED)
...
def level_1():
    try:
        ...
        # total distance travelled by sound, divided by 2 (due to sound return), minus 22.5 cm (gap betwen sensor and water)
        distance = (distance - 22.5)/ 2.0
